...
gsed -i -e 's/uapi\/linux\/random.h/linux\/uapi_random.h/g' include/linux/random.h

gsed -i 's/[[:space:]]*$//' include/linux/uapi_random.h include/linux/random.h include/trace/events/random.h drivers/char/random.c lib/random32.c
